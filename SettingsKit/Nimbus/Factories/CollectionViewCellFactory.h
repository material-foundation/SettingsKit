...
@protocol CollectionViewNibSupplementaryViewObject <NSObject>
@required
- (UINib *)collectionViewSupplementaryViewNib;
@end

@protocol CollectionViewSupplementaryView <NSObject>
@required
- (BOOL)shouldUpdateSupplementaryViewWithObject:(id)object;
@end

@interface CollectionViewCellFactory : NICollectionViewCellFactory
